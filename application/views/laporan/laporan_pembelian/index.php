                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION["data"]["nama"] ?></span>
                            ...
                            <div class="card-header bg-primary text-white font-weight-bold text-uppercase">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6 mt-1">
                                        <i class='fa fa-file-excel'></i> Laporan Pembelian
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <hr>
                                        <a href="<?php echo BASEURL ?>laporan_beli/laporan_pembelian_all" class="btn btn-success btn-icon-split">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form id="form" action="<?php echo BASEURL ?>laporan_beli/laporan_pembelian_periode" method='post'>
