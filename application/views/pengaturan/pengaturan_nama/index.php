        ...
        <?php if ($_SESSION["data"]["tipe"] === "1") : ?>
            ...
            <li class="nav-item">
                ...
                <div id="user" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo BASEURL ?>">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb small">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <i class="fas fa-building"></i> Pengaturan Nama Perusahaan
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="card-header bg-primary text-white font-weight-bold text-uppercase">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6 mt-1">
                                        <i class='fa fa-building'></i> Pengaturan Nama Perusahaan
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nama_lama" id="nama_lama" readonly value="<?php echo $data["perusahaan"]["nama_perusahaan"] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="input-group mb-1" id="nama">
                                                ...
                                                <input type="text" class="form-control" name="nama_baru" id="nama_baru" placeholder="nama perusahaan baru">
                                            </div>
                                            <div id="nama_baruError"></div>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-lg-6 offset-lg-3 text-center">
                                            ...
                                            <button type="button" id="ubahnama" class="btn btn-success btn-icon-split"">
                                                <span class=" icon text-white-50">
                                                <i class="fas fa-edit"></i>
                                                </span>
                                                <span class="text">Ubah Nama</span>
                                            </button>
                                            <button type="button" id="resetnama" class="btn btn-danger btn-icon-split">
                                                <span class=" icon text-white-50">
