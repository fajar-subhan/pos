                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb small">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <i class="fas fa-map-marked-alt"></i> Pengaturan Alamat Perusahaan
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="card mb-2  border-primary">
                            <div class="card-header bg-primary text-white font-weight-bold text-uppercase">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6 mt-1">
                                        <i class='fa fa-building'></i> Pengaturan Alamat Perusahaan
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <form id="formalamat">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="alamat_lama" id="alamat_lama" readonly value="<?php echo $data["perusahaan"]["alamat_perusahaan"] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="input-group mb-1" id="alamat">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <i class="fas fa-map-marked-alt"></i>
                                                    </span>
                                                </div>
                                                <input type="text" class="form-control" name="alamat_baru" id="alamat_baru" placeholder="alamat perusahaan baru">
                                            </div>
                                            <div id="alamat_baruError"></div>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-lg-6 offset-lg-3 text-center">
                                            ...
                                            <button type="button" id="ubahalamat" class="btn btn-success btn-icon-split"">
                                                <span class=" icon text-white-50">
                                                <i class="fas fa-edit"></i>
                                                </span>
                                                <span class="text">Ubah Alamat</span>
                                            </button>
                                            <button type="button" id="resetalamat" class="btn btn-danger btn-icon-split">
                                                <span class=" icon text-white-50">
