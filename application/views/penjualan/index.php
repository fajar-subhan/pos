    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sideactive" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo BASEURL ?>">
            ...
            <div class="sidebar-brand-text mx-3"><strong>POS 1.0</strong></div>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
                            ...
                            <div class="card-header bg-primary text-white font-weight-bold text-uppercase">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6 mt-1">
                                        <i class='fa fa-shopping-cart'></i> Data Penjualan
                                    </div>
                                    <div class="col-xs-12 col-md-6 col-lg-2 offset-lg-4">
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-success btn-sm fa-pull-right font-weight-bold mb-1" id="tomboltambahdatajual" data-toggle="modal" data-target="#formpenjualan">
                                        ...
                                        <tbody class="small">
                                            ...
                                            foreach ($data["data"] as $jual) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Rp <?php echo $jual["harga_jual"] ?></td>
            ...
            <!-- Form Modal Pembeian -->
            <div class="modal fade" id="formpenjualan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="judul_modal">Modal title</h5>
                            <button type="button" class="close" id="closejual" data-dismiss="modal" aria-label="Close">
                            ...
                            <form id="formjual">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="pembeli" class="font-weight-bold">Pembeli <span class='text-danger'>*</span></label>
                                        <input type="text" name="pembeli" id="pembeli" class="form-control" placeholder="nama pembeli" required>
                                        <div id="pembeli_Error"></div>
                                    </div>
                                    <!-- Nama Barang -->
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="qty" id="qtyjual" placeholder="masukan angka saja" required>
                                        <div id="qty_Error"></div>
                                    </div>

                                    <!-- Kode Barang -->
                                    <div class="form-group col-md-6">
                                        <label for="kd_barang" class="font-weight-bold">Kode Barang</label>
                                        <input type="text" class="form-control" name="kd_barang" id="kd_barangjual" required readonly>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="tutupjual" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                            <button type="button" id="tambahpenjualan" class="btn btn-success">Tambah</button>
                        </div>
                        </form>
                    </div>
                </div>
