...
<head>
    ...
    <!-- Date Picker -->
    <link href="<?php echo BASEURL ?>assets/plugin/datepicker/css/datepicker.css" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo BASEURL ?>assets/css/sb-admin-2.min.css" rel="stylesheet">
    <!-- DataTables -->
    <link href="<?php echo BASEURL ?>assets/plugin/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
</head>
